...
const ALL = [
  ...
  { g: 'G6', steps: ['2.3 Stripe billing behind env', '2.4 FOUNDER Supabase project + paste 9999_init.sql + Auth settings', '2.5 FOUNDER Vercel project + Checkpoint A', '2.6 Post-deploy triage (reusable)', '2.7 Hosted smoke test script for the deployed web app (adopted proposal 2026-09-08 — no skeleton bullet; the brief is orchestrator decision 24; 3.7a depends on it)'], draft: true, reads: 'PLAN §7, §12; DESIGN §8, §11 founder action items, §13 risks 4–7; HANDOFF Environment status' },
  ...
  { g: 'G11', steps: ['4.1 Expo scaffold + auth', '4.2 Feed & playback', '4.3 Push & deep links', '4.4 Mobile build docs + CI', '4.5 FOUNDER Expo/EAS/Firebase + Checkpoint C', '4.6 Mobile post-Checkpoint-C polish round (reusable template; adopted 2026-09-08, already in groups/G11.json)'], draft: true, reads: 'PLAN §3 (mobile pins), §6, §9; DESIGN §3, §7, §10, §13 risk 5' },
  ...
  { g: 'G13', steps: ['5.4 Documents', '5.5 Custom audience groups', '5.6 Join codes & join requests (9998_join_codes.sql)', '5.7 Phase 2 hardening', '5.8 Web join landing page /join/[code], QR code, /join/* App Link (adopted 2026-09-08 — brief is orchestrator decision 24)', '5.9 FOUNDER Checkpoint D — Phase 2 trial incl. paste of 9998_join_codes.sql (adopted 2026-09-08 — brief is orchestrator decision 24)'], draft: true, reads: 'PLAN §4, §11; DESIGN §4, §6, §9–§10, §13' },
  { g: 'G14', steps: ['6.1 Surveys (9997_surveys_head_of_house.sql + UI)', '6.2 Audit & scheduling UI', '6.3 Account deletion, privacy, monitoring', '6.4 FOUNDER+AGENT iOS', '6.5 FOUNDER+AGENT Google Play Console internal testing (adopted proposal — see G1.json proposed_additional_steps for the draft)', '6.6 FOUNDER+AGENT Privacy policy and terms of service (adopted 2026-09-07 at the founder request; no skeleton bullet — the full brief is orchestrator decision 16; 6.4 and 6.5 depend on it)', '6.7 FOUNDER paste the Phase 3 migrations (9997, and 9996 in case B) + ledger (adopted 2026-09-08 — brief is orchestrator decision 24; 6.4 and 6.5 depend on it)', '6.8 FOUNDER+AGENT Production release: Play closed test → production, App Store review (adopted 2026-09-08 — brief is orchestrator decision 24)'], draft: true, reads: 'PLAN §4 (surveys, audit, account deletion), §11 Phase 3; DESIGN §4, §10, §11 Phase 3, §13' },
]
