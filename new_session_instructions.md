...
## 6. Unless otherwise instructed, always commit to the main branch of the repo

The user will occasionally indicate if they want the session to work on a separate branch, otherwise, you have permission to merge and commit to main for the entirety of the session
